    ...
    route_specs = [
        {
            ...
            "tasks": [
                ...
                ("红棉广场", "红棉留影", "拍摄广场中的木棉、校徽或文化景观细节。", TaskType.CHECK_IN, "请上传红棉广场文化景观照片", None, None, 15, 100),
                ("校史展示点", "文脉记录", "观察校史展示内容，拍摄一处有代表性的校园记忆。", TaskType.CHECK_IN, "请上传校史展示点现场照片", None, None, 20, 100),
