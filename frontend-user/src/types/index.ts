...
export interface RouteTask extends Entity { route_id: number; culture_item_id: number | null; location_id: number; order_no: number; title: string; description: string; task_type: string; question: string | null; options: string[] | null; points: number; qr_code: string | null; latitude: string | null; longitude: string | null; radius_meters: number }
...
export interface RouteProgressRecord { recordId: number; taskId: number; status: string; awardedPoints: number; completedAt: string | null; answer: string | null }
