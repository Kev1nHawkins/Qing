...
const typeLabels: Record<string, string> = {
  ...
  QUIZ: '文化问答',
  QR_CODE: '图片打卡',
  SIMULATED_LOCATION: '图片打卡',
}
const isPhotoTask = computed(() => props.task.task_type !== 'QUIZ')
